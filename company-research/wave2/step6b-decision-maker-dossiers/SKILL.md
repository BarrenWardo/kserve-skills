...
|---|---|---|
| Formal Executive | Sparse profile, no personal posts, corporate bio language | Lead with ROI data and case studies; keep outreach concise and professional |
...
| Minimal Online Presence | No posts, no activity, basic profile | Fall back to company news and industry context; LinkedIn activity won't provide hooks |
