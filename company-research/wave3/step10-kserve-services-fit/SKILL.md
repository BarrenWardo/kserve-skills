...
- **AI services fit rules:**
  ...
  - **Conversation VoiceAI Bot** — HIGH FIT: Published support number + lean team signals (6-day week, high call load from reviews) OR multi-language market presence. MEDIUM FIT: Single-language support team with posted number.
  ...
  - **WhatsApp Chatbot** — HIGH FIT: WhatsApp Business number detected (Step 11/12) OR Indian consumer/MSME-facing company. MEDIUM FIT: B2C company without visible WhatsApp number.
